        ...
        <div className="about__body__content">
          <div className="about__body__text">
            ...
            <p>
              ...
              <br /> Soluta totam assumenda qui est pariatur earum eum sit,
              <br /> amet culpa autem recusandae nulla quod
              <br /> magni omnis minus molestias ab molestiae magnam.
            </p>
          </div>
          ...
          <div className="about__boxes__container">
            <div className="box">
              ...
              <p>
                ...
                tempora laboriosam iste exercitationem non
              </p>
